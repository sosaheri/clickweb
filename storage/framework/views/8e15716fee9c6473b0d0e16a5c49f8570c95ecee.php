                    ...
                    <?php if(isset($section['restorants'])): ?>
                        <?php $__empty_1 = true; $__currentLoopData = $section['restorants']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restorant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                <div class="strip">
                                    <figure>
                                    <a ><img src="<?php echo e($restorant->logom); ?>" data-src="<?php echo e(config('global.restorant_details_image')); ?>" class="img-fluid lazy" alt=""></a>
                                    </figure>
                                   
                                    <span class="res_title"><b><a href=""><?php echo e($restorant->name); ?></a></b></span><span class="float-right"><i class="fa fa-star" style="color: #dc3545"></i> <strong><?php echo e(number_format($restorant->averageRating, 1, '.', ',')); ?> <span class="small">/ 5 (<?php echo e(count($restorant->ratings)); ?>)</strong></span></span><br />
                                    ...
                                    <div class="row">    
                                         <a href="<?php echo e(URL::route('front')); ?>" style="align-self: center;margin-left: auto;">
                                         <img border="0" alt="" src="<?php echo e(asset('images/default/like.png')); ?>" width="34" >
                                         </a> <a href="<?php echo e(URL::route('front')); ?>">
...
<?php endif; ?>
  ...
  <?php if( !request()->get('location') ): ?>
        <?php echo $__env->make('layouts.headers.search2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
        <?php echo $__env->make('layouts.headers.filters2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\delivery\Admin\resources\views/service.blade.php ENDPATH**/ ?>