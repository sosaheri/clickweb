 ...
 <!--    <?php if(config('settings.enable_pricing')): ?>
    ...
    <?php endif; ?> -->
        ...
        <?php endif; ?>
         ...
         <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('driver.employ.show')); ?>">
...
<?php /**PATH C:\xampp\htdocs\delivery\Admin\resources\views/layouts/navbars/menus/owner.blade.php ENDPATH**/ ?>