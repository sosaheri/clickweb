<ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('index')); ?>">
                        <i class="ni ni-tv-2 text-primar"></i>Nuevos Pedidos
                    </a>
                </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>">
                        <i class="ni ni-basket text-orange"></i> Listado pedidos
                    </a>
                </li>
            </ul>
<?php /**PATH /home/aanpdrqr/public_html/resources/views/layouts/navbars/menus/driver.blade.php ENDPATH**/ ?>