                ...
                <ul class="nav nav-pills bg-white mb-2">
                    <li class="nav-item nav-item-category ">
                        <a class="nav-link  mb-sm-3 mb-md-0 active" data-toggle="tab" role="tab" href=""><?php echo e(__('All categories')); ?></a>
                            ...
                            <li class="nav-item nav-item-category">
                                <a class="nav-link mb-sm-3 mb-md-0" data-toggle="tab" role="tab">new order</a>
                            </li>
                               <li class="nav-item nav-item-category" >
                                <a class="nav-link mb-sm-3 mb-md-0" data-toggle="tab" role="tab" > name</a>
                            </li>
...
$(document).ready(function(){
  $(".cashOnDelivery").click(function(){
    $(".cashOnDeliveryReturn").show();
  });
});
$(document).ready(function(){
  $(".paymentStripe").click(function(){
    $(".cashOnDeliveryReturn").hide();
  });
});
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\delivery\Admin\resources\views/orders/live2.blade.php ENDPATH**/ ?>