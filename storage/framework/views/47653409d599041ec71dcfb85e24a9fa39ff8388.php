...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('items.partials.modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <?php if(auth()->user()->hasRole('services')): ?>
        <?php echo $__env->make('items.partials.header', ['title' => 'Administrador De Servicios'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', ['title' =>' Administrador' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\delivery\Admin\resources\views/items/index.blade.php ENDPATH**/ ?>