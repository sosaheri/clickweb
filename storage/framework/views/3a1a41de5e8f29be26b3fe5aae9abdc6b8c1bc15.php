...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Administrdor De Sevicios </h3>
                    ...
                    <div class="card-body">
                       <h6 class="heading-small text-muted mb-4">Informacion De Sevicios</h6>
                        <?php echo $__env->make('partials.flash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    ...
                                                    <div class="pl-lg-4">
                                                        <form method="post" action="<?php echo e(route('admin.restaurants.update', $restorant)); ?>" autocomplete="off" enctype="multipart/form-data">
                                                            ...
                                                            ['ftype'=>'input','name'=>"Nombre De La Empresa",'id'=>"name",'placeholder'=>"Restaurant Name",'required'=>true,'value'=>$restorant->name],
                                                            ['ftype'=>'input','name'=>"Descripcion Del Servicio",'id'=>"description",'placeholder'=>"Restaurant description",'required'=>true,'value'=>$restorant->description],
                                                            ['ftype'=>'input','name'=>"Direccion",'id'=>"address",'placeholder'=>"Restaurant description",'required'=>true,'value'=>$restorant->address],
                                                            ['ftype'=>'input','name'=>"Telefono",'id'=>"phone",'placeholder'=>"Restaurant phone",'required'=>true,'value'=>$restorant->phone],
    ...
    <div class="card-header">
        <h5 class="h3 mb-0">Horario De Trabajo</h5>
    </div>
    <div class="card-body">
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\delivery\Admin\resources\views/restorants/service_edit.blade.php ENDPATH**/ ?>