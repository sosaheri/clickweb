          ...
          <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
            <li class="nav-item dropdown">
                <?php if(auth()->guard()->check()): ?>
                    <?php echo $__env->make('layouts.menu.partials.authn', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
                <?php if(auth()->guard()->guest()): ?>
                    <?php echo $__env->make('layouts.menu.partials.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            </li>
            <li class="web-menu" style="margin-left: 25rem;">
            ...
            <li class="web-menu" style="margin-left: 38rem;">
...
<?php /**PATH C:\xampp\htdocs\delivery\Admin\resources\views/layouts/menu/top.blade.php ENDPATH**/ ?>