<div class="card card-profile shadow">
                ...
                <select name="addressID" id="addressID" class="form-control<?php echo e($errors->has('addressID') ? ' is-invalid' : ''); ?>  noselecttwo" required>
                    ...
                    <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(config('settings.enable_cost_per_distance')): ?>
                            <option data-cost=<?php echo e($address->cost_per_km); ?> id="<?php echo e('address'.$address->id); ?>"   value=<?php echo e($address->id); ?>><?php echo e($address->address." - ".money( $address->cost_per_km, config('settings.cashier_currency'),config('settings.do_convertion'))); ?> </option>
                        <?php else: ?>
                    <option data-cost=<?php echo e(config('global.delivery')); ?> id="<?php echo e('address'.$address->id); ?>"  value=<?php echo e($address->id); ?>><?php echo e($address->address); ?> </option>
                        <?php endif; ?>
  ...
  <br />
<?php /**PATH /home/aanpdrqr/public_html/resources/views/cart/address.blade.php ENDPATH**/ ?>