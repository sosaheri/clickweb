            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="title white"  <?php if($restorant->description || $openingTime && $closingTime){echo 'style="border-bottom: 1px solid #f2f2f2;"';} ?> >
                       ...
                       | <span>(Recogida y a domicilio) a 6 km | precio a domicilio   <?php echo money($restorant->static_fee, config('settings.cashier_currency'),config('settings.do_convertion')); ?> </span>
                         <a href="<?php echo e($add); ?>">
    ...
    <section class="section pt-lg-0" id="restaurant-content" style="padding-top: 0px">
       ...
       <!--      <?php if(!$restorant->categories->isEmpty()): ?>
        ...
        <div id="accordion">
          ...
          <div id="<?php echo e(clean(str_replace(' ', '', strtolower($category->name)).strval($key))); ?>" class="<?php echo e(clean(str_replace(' ', '', strtolower($category->name)).strval($key))); ?>">
            ...
            <div class="card">
                <div class="card-header" id="headingOne">
                  <h5 class="mb-0">
                    <button class="btn btn-link" data-toggle="collapse" data-target="#p<?php echo e($category->id); ?>" aria-expanded="false" aria-controls="collapseOne">
          ...
          <div id="p<?php echo e($category->id); ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
              <div class="card-body">
               <?php $__currentLoopData = $category->aitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                <div class="strip">
...
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aanpdrqr/public_html/resources/views/restorants/show.blade.php ENDPATH**/ ?>