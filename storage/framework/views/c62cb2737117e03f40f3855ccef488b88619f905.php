<div class="card card-profile shadow mt--300">
                    ...
                    <div class="col">
                        ...
                        <?php if(!config('settings.hide_cod')): ?>
                            <div class="custom-control custom-radio mb-3">
                                <input name="paymentType" class="custom-control-input cashOnDelivery" id="cashOnDelivery" type="radio" value="cod" <?php echo e(config('settings.default_payment')=="cod"?"checked":""); ?>>
                        ...
                        <?php if($enablePayments): ?>
                            ...
                            <?php if(config('settings.stripe_key')&&config('settings.enable_stripe')): ?>
                                <div class="custom-control custom-radio mb-3">
                                    <input name="paymentType" class="custom-control-input paymentStripe" id="paymentStripe" type="radio" value="stripe" <?php echo e(config('settings.default_payment')=="stripe"?"checked":""); ?>>
  ...
  <?php endif; ?>
<?php /**PATH C:\xampp\htdocs\delivery\Admin\resources\views/cart/payment.blade.php ENDPATH**/ ?>