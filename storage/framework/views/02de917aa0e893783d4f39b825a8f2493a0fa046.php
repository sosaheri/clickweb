...
<?php if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('owner') || auth()->user()->hasRole('driver')): ?>
    ...
    <td>
        ...
        <?php elseif($lastStatusAlisas == "assigned_to_driver"): ?>
             <a href="<?php echo e(url('updatestatus/accepted_by_driver/'.$order->id)); ?>" class="btn btn-success btn-sm order-action"><?php echo e(__('Accept')); ?></a>
             <a href="<?php echo e(url('updatestatus/rejected_by_driver/'.$order->id)); ?>" class="btn btn-danger btn-sm order-action"><?php echo e(__('Reject')); ?></a>
               <?php elseif($lastStatusAlisas == "accepted_by_driver"): ?>
              <a href="<?php echo e('updatestatus/picked_up/'.$order->id); ?>" class="btn btn-primary btn-sm order-action"><?php echo e(__('Picked Up')); ?></a>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/aanpdrqr/public_html/resources/views/orders/partials/actions/table.blade.php ENDPATH**/ ?>