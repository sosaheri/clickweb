    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <?php endif; ?>
               ...
               <?php if(auth()->user()->hasRole('owner')&&auth()->user()->hasRole('services')): ?>
                <?php echo $__env->make('layouts.navbars.menus.service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
               <?php elseif(auth()->user()->hasRole('owner')&&auth()->user()->hasRole('store')): ?>
               
                <?php echo $__env->make('layouts.navbars.menus.store', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\delivery\Admin\resources\views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>