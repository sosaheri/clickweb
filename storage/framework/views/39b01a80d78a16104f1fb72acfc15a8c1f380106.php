                    ...
                    <?php if(isset($section['restorants'])): ?>
                        <?php $__empty_1 = true; $__currentLoopData = $section['restorants']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restorant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php $link=route('vendor',['alias'=>$restorant["alias"]]);
                              $del=route('list.delete',$restorant["id"]); 
                             ?>
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                <div class="strip">
                                    ...
                                    <span class="res_title"><b><a href="<?php echo e($link); ?>"><?php echo e($restorant["name"]); ?></a></b></span><span class="float-right"><i class="fa fa-star" style="color: #dc3545"></i> <strong><?php echo e(number_format(3, 1, '.', ',')); ?> <span class="small">/ 5 (<?php echo e(2); ?>)</strong></span></span><br />
...
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aanpdrqr/public_html/resources/views/links.blade.php ENDPATH**/ ?>