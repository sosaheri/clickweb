                    ...
                    @isset($section['restorants'])
                        @forelse ($section['restorants'] as $restorant)
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                <div class="strip">
                                    <figure>
                                    <a ><img src="{{ $restorant->logom }}" data-src="{{ config('global.restorant_details_image') }}" class="img-fluid lazy" alt=""></a>
                                    </figure>
                                   
                                    <span class="res_title"><b><a href="">{{ $restorant->name}}</a></b></span><span class="float-right"><i class="fa fa-star" style="color: #dc3545"></i> <strong>{{ number_format($restorant->averageRating, 1, '.', ',') }} <span class="small">/ 5 ({{ count($restorant->ratings) }})</strong></span></span><br />
                                    ...
                                    <div class="row">    
                                         <a href="{{ URL::route('front') }}" style="align-self: center;margin-left: auto;">
...
@endif
  ...
  @if( !request()->get('location') )
        @include('layouts.headers.search2')
    @else
        @include('layouts.headers.filters2')
    @endif
