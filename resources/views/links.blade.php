                        ...
                        @forelse ($section['restorants'] as $restorant)
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                <div class="strip">
                                    ...
                                    <span class="res_title"><b><a href="{{ $link }}">{{ $restorant["name"]}}</a></b></span><span class="float-right"><i class="fa fa-star" style="color: #dc3545"></i> <strong>{{ number_format(3, 1, '.', ',') }} <span class="small">/ 5 ({{ 2 }})</strong></span></span><br />
