    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            @endif
               ...
               @if(auth()->user()->hasRole('owner')&&auth()->user()->hasRole('services'))
                @include('layouts.navbars.menus.service')
               @elseif(auth()->user()->hasRole('owner')&&auth()->user()->hasRole('store'))
               
                @include('layouts.navbars.menus.store')
