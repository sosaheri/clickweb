...
Route::get('/service', 'FrontEndController@showService')->name('show.Service');
Route::get('/shop', 'FrontEndController@showShops')->name('show.shop');
Route::get('/linklist', 'FrontEndController@showLink')->name('show.link');
Route::get('/lang', 'FrontEndController@langswitch')->name('lang.switch');
Route::get('/linklist/del/{id}', 'FrontEndController@destroy')->name('list.delete');
Route::get('/linklist/add/{id}', 'FrontEndController@addList')->name('list.add');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/restaurant/workinghours', 'RestorantController@workingHours')->name('restaurant.workinghours');
     ...
     Route::get('/services/{restaurant}', 'RestorantController@editService')->name('service.edit');
...
Route::get('new/employ/register', 'EmployController@register')->name('driver.employ.register');
Route::get('new/employ/show', 'EmployController@showEmployes')->name('driver.employ.show');
Route::post('new/employ/store', 'EmployController@storeRegisterEmployes')->name('driver.employ.store');
 Route::get('/employ/updatestatus/{alias}/{driver}', 'EmployController@updateStatus')->name('driver.employ.updateStatus');
